# Agent Harness V2 Archive

这组文档记录了 `2026-04-06 Agent Harness V2` 这一轮分片计划、正式 cutover 计划与设计审查材料。

归档时间：`2026-04-07`

归档原因：

- Agent Harness V2 的 official cutover 已完成，正式架构已进入当前 source-of-truth 文档
- 这组计划和审查材料的职责已经转为历史追踪，不再需要占用活动 `docs/superpowers/` / `docs/issues/` 入口
- 后续若继续推进 harness 增量能力，应以新的独立切片文档记录，而不是继续复用这组旧计划

归档内容：

- [agent-harness-v2-design-review.md](/D:/Claude-project/ccode-win7/docs/archive/agent-harness-v2/agent-harness-v2-design-review.md)
- [2026-04-06-agent-harness-v2-foundation.md](/D:/Claude-project/ccode-win7/docs/archive/agent-harness-v2/2026-04-06-agent-harness-v2-foundation.md)
- [2026-04-06-agent-harness-v2-full-spec-taskgraph.md](/D:/Claude-project/ccode-win7/docs/archive/agent-harness-v2/2026-04-06-agent-harness-v2-full-spec-taskgraph.md)
