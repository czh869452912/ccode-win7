...
|---|---|---|---|---|
| Agent Core | `src/embedagent/query_engine.py`, `src/embedagent/inprocess_adapter.py`, `src/embedagent/session_runtime.py` | `docs/overall-solution-architecture.md`, `docs/agent-harness-v2.md` | `docs/modules/agent-core.md` | `docs/references/glossary.md`, `docs/workflows/code-doc-sync.md` |
...
| Harness | `src/embedagent/harness/` | `docs/overall-solution-architecture.md`, `docs/mode-schema.md`, `docs/agent-harness-v2.md` | `docs/modules/harness.md` | `docs/references/glossary.md`, `docs/workflows/architecture-change-process.md` |
...
| Permissions / Context | `src/embedagent/permissions.py`, `src/embedagent/context.py`, `src/embedagent/workspace_intelligence.py` | `docs/permission-model.md`, `docs/overall-solution-architecture.md` | `docs/modules/permissions-and-context.md` | `docs/references/glossary.md`, `docs/references/diagrams-conventions.md` |
...
| Packaging / Deployment | `scripts/`, packaging docs, Win7 validation docs | `README.md`, `docs/implementation-roadmap.md` | `docs/modules/packaging-and-deployment.md` | `docs/workflows/release-doc-checklist.md`, `docs/references/glossary.md` |
