...
| Application plugin loading | `src/embedagent/application_loader.py`, `packages/embedagent-composition/src/embedagent_composition/application.py`, plugin `application.py` entries | `docs/guides/application-plugin-authoring.md` | `docs/adrs/0008-generic-agent-application-plugin-closure-export.md` |
