...
<!-- For checkpoint task examples and patterns, see @D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/checkpoints.md -->
...
See `D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Claude-project/ccode-win7/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
