...
```
Task(
  prompt="Read D:/Claude-project/ccode-win7/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/VALIDATION.md`
