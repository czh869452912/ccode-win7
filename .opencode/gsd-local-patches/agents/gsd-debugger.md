...
<required_reading>
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Claude-project/ccode-win7/.opencode
                  → checks D:/Claude-project/ccode-win7/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Claude-project/ccode-win7/.opencode/get-shit-done
                  → writes to D:/Claude-project/ccode-win7/.opencode/get-shit-done/hooks/
...
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/common-bug-patterns.md
