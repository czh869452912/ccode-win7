...
Reference full template: `D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/state.md`.
