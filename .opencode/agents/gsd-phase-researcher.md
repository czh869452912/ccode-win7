...
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/Claude-project/ccode-win7/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
