...
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/revision-loop.md
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/gate-prompts.md
...
**If found:**
1. Read template: `D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/tdd.md to all eligible tasks:
...
if [ "$POST_PLANNING_GAPS" = "true" ]; then
  node "D:/Claude-project/ccode-win7/.opencode/get-shit-done/bin/gsd-tools.cjs" gap-analysis --phase-dir "${PHASE_DIR}"
fi
```
