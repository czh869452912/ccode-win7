...
Key references:
- @D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Claude-project/ccode-win7/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Claude-project/ccode-win7/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/Claude-project/ccode-win7/.opencode/get-shit-done/USER-PROFILE.md" "D:/Claude-project/ccode-win7/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Claude-project/ccode-win7/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Claude-project/ccode-win7/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/Claude-project/ccode-win7/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Claude-project/ccode-win7/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Claude-project/ccode-win7/.opencode/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/Claude-project/ccode-win7/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="D:/Claude-project/ccode-win7/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Claude-project/ccode-win7/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Claude-project/ccode-win7/.opencode/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        D:/Claude-project/ccode-win7/.opencode/AGENTS.md
```
