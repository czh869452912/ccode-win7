...
INSTALL_JS_GLOBAL="D:/Claude-project/ccode-win7/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Claude-project/ccode-win7/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
