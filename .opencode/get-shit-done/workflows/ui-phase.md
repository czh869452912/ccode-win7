...
```markdown
Read D:/Claude-project/ccode-win7/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Claude-project/ccode-win7/.opencode/agents/gsd-ui-checker.md for instructions.
