...
- **Global scope**: `D:/Claude-project/ccode-win7/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Claude-project/ccode-win7/.opencode/notes/`)
...
2. Glob `D:/Claude-project/ccode-win7/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (D:/Claude-project/ccode-win7/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Claude-project/ccode-win7/.opencode/notes/` — works in any directory
