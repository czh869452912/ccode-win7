...
```bash
INIT=$(node "D:/Claude-project/ccode-win7/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/Claude-project/ccode-win7/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
