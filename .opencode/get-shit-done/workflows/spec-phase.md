...
```bash
INIT=$(node "D:/Claude-project/ccode-win7/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/spec.md.
