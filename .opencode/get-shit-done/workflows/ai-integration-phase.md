...
<required_reading>
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/ai-frameworks.md
@D:/Claude-project/ccode-win7/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Claude-project/ccode-win7/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Claude-project/ccode-win7/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Claude-project/ccode-win7/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Claude-project/ccode-win7/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Claude-project/ccode-win7/.opencode/agents/gsd-eval-planner.md for instructions.
