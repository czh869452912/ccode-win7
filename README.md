...
- Remaining work: capability/workflow-package control-plane manifests, structured compaction state, clean Win7 bundle smoke, real C project validation, and stale compatibility cleanup
