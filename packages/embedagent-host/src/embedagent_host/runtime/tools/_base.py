...
from embedagent_host.runtime.constants import should_skip_directory
from embedagent_host.runtime.local_resources import discover_local_resources
from embedagent_host.runtime.runtime_discovery import discover_bundle_root
from embedagent_host.runtime.workspace_recipes import (
...
class ToolContext(object):
    ...
    def __init__(
        ...
        workspace: str,
        app_config: Any = None,
        command_sanitizer_factory: Optional[Callable[[], Any]] = None,
        bundle_root_resolver: Optional[Callable[..., Optional[str]]] = None,
    ) -> None:
        ...
        self._command_sanitizer_factory = command_sanitizer_factory or CommandSanitizer
        self._bundle_root_resolver = bundle_root_resolver or discover_bundle_root
    ...
    def command_sanitizer(self) -> Any:
        return self._command_sanitizer_factory()
