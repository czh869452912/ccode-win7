...
class SessionSummaryStore(object):
    def __init__(
        ...
        system_prompt_builder: Optional[Callable[[str, Any, str], str]] = None,
        workspace_profile_builder: Optional[Callable[[str, str], str]] = None,
    ) -> None:
        ...
        self.workspace_profile_builder = (
            workspace_profile_builder or build_workspace_profile_message
        )
