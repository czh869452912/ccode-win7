...
def default_app_shell_spec() -> AppShellSpec:
    return AppShellSpec(
        ...
        command_palette_groups=(
            _palette_group("app", "App", "App shell commands", 10, leading="A"),
            _palette_group(
                "session",
                "Sessions",
                "Create, refresh, and resume threads",
                20,
                leading="S",
            ),
            _palette_group(
                "message",
                "Message",
                "Send or stop the current turn",
                30,
                leading="M",
            ),
            _palette_group("mode", "Mode", "Switch the active agent mode", 40, leading="M"),
            _palette_group(
                "surface",
                "Surface",
            ...
            _palette_group(
                "workspace",
                "Workspace",
                "Open or refresh local workspaces",
                60,
                leading="W",
            ),
            _palette_group(
            ...
            _palette_group("view", "View", "Toggle workbench layout", 80, leading="V"),
        ),
